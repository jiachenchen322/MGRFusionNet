...
class TopKPooling(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr=None, batch=None, attn=None):
        ...
        # score = score.view(-1)
        score_mean = scatter_mean(score,batch) #score is a vector that has the same size as batch
        score = score - score_mean[batch]
        ...
        x = x[perm] #* score[perm].view(-1, 1) # YL: don't think it make sense to multiply score
